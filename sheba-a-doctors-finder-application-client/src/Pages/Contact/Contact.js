...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('gmail', 'template_6l3nqc6', form.current, 'user_zZF2qj887EBUVcRUxWz9A')
            .then((result) => {
                toast.success("Thank you for your mail. We will contact with you very soon..")
            }, (error) => {
                            ...
                            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                                <div className="mb-12 max-w-[570px] lg:mb-0">
                                    ...
                                    <p className="text-body-color mb-9 text-base leading-relaxed">
                                        The Doctors Portal Institutes are regarded as one of the best heart hospitals in Bangladesh, performing a multitude of treatments and procedures in cardiology and cardiothoracic surgery.
                                    </p>
                                    <div className="mb-8 flex w-full max-w-[370px]">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <p className="text-body-color text-base">
                                               House - 1, Road -1,  Block - A, Bashundhara R/A, Dhaka
                                            </p>
                                        </div>
                                    </div>
                                    <div className="mb-8 flex w-full max-w-[370px]">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <p className="text-body-color text-base">(+88)01 777 777 777</p>
                                        </div>
                                    </div>
                                    <div className="mb-8 flex w-full max-w-[370px]">
                                        <div
                                        ...
                                        <div className="w-full">
                                            ...
                                            <p className="text-body-color text-base">cse499ab@gmail.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
